define(["heyui/lib/utils/utils","heyui/lib/locale","heyui/lib/plugins/message"], function(__WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__11__, __WEBPACK_EXTERNAL_MODULE__12__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var wordlimit = function wordlimit(el, total) {
  ...
  if (v > total) {
    ...
    if (el.getAttribute('data-alerted') == '0') {
      _message.default.error(_locale.default.t('h.wordlimit.warn', [total]));
    }
