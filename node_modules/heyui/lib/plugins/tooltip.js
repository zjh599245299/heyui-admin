define(["heyui/lib/utils/utils","heyui/lib/plugins/pop"], function(__WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__193__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(188));

var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(190));

var _inherits2 = _interopRequireDefault(__webpack_require__(191));

var _pop = _interopRequireDefault(__webpack_require__(193));
...
/*#__PURE__*/
function (_Pop) {
  (0, _inherits2.default)(Tooltip, _Pop);
  ...
  function Tooltip(el, param) {
    ...
    if (param.theme) {
      classes.push("h-tooltip-".concat(param.theme));
    }
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Tooltip).call(this, el, param));
  }

  (0, _createClass2.default)(Tooltip, [{
    key: "updateTemplate",
    value: function updateTemplate(content, html) {
      _utils.default.extend(this.options, {
        content: content,
        html: html
      });
