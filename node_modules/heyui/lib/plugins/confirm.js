define(["heyui/lib/utils/utils","heyui/lib/locale","heyui/lib/plugins/notify"], function(__WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__11__, __WEBPACK_EXTERNAL_MODULE__24__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _notify = _interopRequireDefault(__webpack_require__(24));
...
function Confirm(content, title) {
  return new Promise(function (resolve, reject) {
    var param = {
      type: prefixCls,
      content: "<div><i class=\"h-icon-warn yellow-color\" style=\"font-size:28px;vertical-align: -8px;\"></i>&nbsp;&nbsp;".concat(content, "</div>"),
      buttons: ['cancel', 'ok'],
      events: {
        ok: function ok(n) {
          n.close();
...
function confirm(content, title) {
  if (!title) {
    title = _locale.default.t('h.confirm.title');
  }
